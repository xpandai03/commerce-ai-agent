  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-zinc-500 mt-2">Configure system preferences and integrations</p>
      </div>
      ...
      <Card className="bg-zinc-900 border-zinc-800 p-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label className="text-white">Supabase Anon Key</Label>
            <Input
              type="password"
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-500">GPT-4 Turbo</p>
            </div>
      ...
      <Card className="bg-zinc-900 border-zinc-800 p-6 mb-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <Label className="text-white">Enable Chat Logging</Label>
              <p className="text-sm text-zinc-500">Store chat conversations for analysis</p>
            </div>
            <Switch disabled />
          </div>
          <div className="flex items-center justify-between">
            <div>
              <Label className="text-white">Auto-save Prompts</Label>
              <p className="text-sm text-zinc-500">Automatically save prompt changes</p>
            </div>
            <Switch disabled />
          </div>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-500">Track usage statistics</p>
            </div>
            <Switch disabled />
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-500">Receive system alerts via email</p>
            </div>
            <Switch disabled />
          </div>
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-500">Get notified when errors occur</p>
            </div>
            <Switch disabled />
          </div>
        </div>
      ...
      <Card className="bg-zinc-900/50 border-zinc-800 p-4 mt-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-semibold mb-1 text-white">Configuration Status</h4>
